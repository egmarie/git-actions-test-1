  ...
  return (
    ...
    <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
      <group name="Scene">
        ...
        <spotLight name="Point" intensity={543.514} angle={0.794} penumbra={0.15} decay={2} distance={9.67} position={[-30.442, 3.664, 17.647]} rotation={[-2.261, -0.523, -0.27]} scale={0.059}>
        ...
        <pointLight name="loomo-light" intensity={5435.141} decay={2} position={[-1.251, -0.932, -38.475]} rotation={[3.13, -0.111, 2.801]} scale={1.831} />
        <pointLight name="outside-light-2" intensity={9511.497} decay={2} color="#ffd494" position={[-63.186, 18.874, 1.245]} rotation={[-0.301, -1.108, 1.3]} scale={6.177} />
        <pointLight name="main-light" intensity={3804.599} decay={2} color="#ffedca" position={[-12.195, 36.175, 2.646]} rotation={[-Math.PI / 2, 0, 0]} scale={3.635} />
        <pointLight name="lamp-light" intensity={163.054} decay={2} position={[-0.586, 8.197, 28.362]} rotation={[-Math.PI / 2, 0, 0]} />
        <pointLight name="spot-light4001" intensity={2717.571} decay={2} position={[-22.863, 4.329, -34.945]} rotation={[3.13, 0.114, 2.804]} scale={1.831} />
...
useGLTF.preload('/lab-08-28-v15.glb')
