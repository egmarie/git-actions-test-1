  ...
  return (
    ...
    <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
      <group name="Scene">
        ...
        <spotLight name="spot-light4001" intensity={869.623} angle={1.119} penumbra={0.15} decay={2} position={[-28.093, -0.932, -38.475]} rotation={[3.13, -0.111, 2.801]} scale={1.831}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="spot-light4" intensity={869.623} angle={1.119} penumbra={0.15} decay={2} position={[-1.251, -0.932, -38.475]} rotation={[3.13, -0.111, 2.801]} scale={1.831}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="spot-light2" intensity={434.811} angle={0.472} penumbra={0.15} decay={2} color="#ffd494" position={[-102.147, 18.479, 39.471]} rotation={[-0.301, -1.108, 1.3]} scale={6.177}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="spot-light1" intensity={1358.785} angle={0.588} penumbra={1} decay={2} position={[-30.401, 3.526, 17.719]} rotation={[-2.413, -0.571, -1.01]} scale={0.241}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="area-light1" intensity={271.757} angle={1.223} penumbra={0.392} decay={2} color="#ffedca" position={[-12.195, 36.175, 2.646]} rotation={[-Math.PI / 2, 0, 0]} scale={3.635}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="outside-light1" intensity={380.46} angle={1.122} penumbra={0.03} decay={2} color="#ffdc8d" position={[-82.688, 36.469, 2.646]} rotation={[-Math.PI / 2, -1.026, 0]} scale={3.635}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <pointLight name="Point" intensity={163.054} decay={2} position={[-0.586, 8.197, 28.362]} rotation={[-Math.PI / 2, 0, 0]} />
