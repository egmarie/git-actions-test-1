  ...
  const loomoCamera = useCamera(cameras[3])
    useEffect(() => {
      if (camera?.scenes === 'intro') {
        ...
        alert(camera?.scenes)
        // const openingCamera = useCamera(cameras[2])
      }
    })
  ...
  return (
    ...
    <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="vr-camera" makeDefault={camera?.scenes === 'VR' ? true : false} far={1000} near={0.1} fov={22.895} position={[-5.164, 10.935, -1.95]} rotation={[-2.633, 0.718, 2.79]} />
        <PerspectiveCamera name="vol-cap-camera" makeDefault={camera?.scenes === 'Volcap' ? true : false} far={1000} near={0.1} fov={22.895} position={[10.569, 28.363, -25.707]} rotation={[-2.162, 0.874, 2.29]} />
        <PerspectiveCamera name="opening-camera" makeDefault={camera?.scenes === '' ? true : false} far={1000} near={0.1} fov={22.895} position={[81.283, 63.531, -86.473]} rotation={[-2.523, 0.701, 2.711]} />
        <PerspectiveCamera name="loomo-camera" makeDefault={camera?.scenes === 'Loomo' ? true : false} far={1000} near={0.1} fov={22.895} position={[11.43, 13.003, -24.303]} rotation={[-2.454, 0.624, 2.694]} />
        <PerspectiveCamera name="aria-camera" makeDefault={camera?.scenes === 'Aria' ? true : false} far={1000} near={0.1} fov={22.895} position={[22.311, 20.733, -15.631]} rotation={[-2.67, 0.528, 2.89]} />
...
useGLTF.preload('/lab-08-22-v2.glb')
