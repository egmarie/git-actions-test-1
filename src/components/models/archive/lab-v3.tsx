...
Command: npx gltfjsx@6.2.10 lab-08-04.gltf 
*/
...
export default function Lab(props:any) {
  ...
  const { nodes, materials, animations, scene, cameras } = useGLTF('/gltf/lab-08-04-v1/lab-08-04.gltf')
  const { actions } = useAnimations(animations, group)
  //add setCamera function for changing the camera view
  // const { camera1 } = useCamera('camera-1')
  // const { camera2 } = useCamera('camera-2')
  // const { camera3 } = useCamera('camera-3')
  // const { camera4 } = useCamera('camera-4')
  // const { camera5 } = useCamera('camera-5')
  // const { camera6 } = useCamera('camera-6')
  const camera1a = cameras.find((camera:any) => camera.name = 'camera-1')
  const camera1 = useCamera(cameras[3])
  console.log(camera1)
  console.log(camera1a)
  console.log(cameras)
  console.log(actions)
    ...
    <Suspense fallback={null}>
      <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
        <group name="Scene">
          ...
          <PerspectiveCamera name="opening-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[82, 50, -90]} rotation={[-2.664, 0.732, 2.808]} />
          <PerspectiveCamera name="aria-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[21.46, 17.564, -7.58]} rotation={[-2.594, 0.573, 2.822]} />
          <PerspectiveCamera name="vr-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[-5.168, 10.935, -1.95]} rotation={[-2.637, 0.711, 2.796]} />
          <PerspectiveCamera name="vol-cap-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[14, 30, -28.854]} rotation={[-2.094, 0.891, 2.209]} />
          <PerspectiveCamera name="loomo-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[11.43, 13.003, -24.303]} rotation={[-2.45, 0.631, 2.688]} />
          <PerspectiveCamera name="animated-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[15.73, 15.74, -24.96]} rotation={[-2.352, 0.712, 2.559]} />
          
          <PerspectiveCamera name="0-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[76.612, 48.828, -87.016]} rotation={[-2.641, 0.717, 2.797]} />
          <PerspectiveCamera name="1-camera" makeDefault={(scene1 == 'Loomo' ? true : false)} far={1000} near={0.1} fov={22.895} position={[76.612, 48.828, -87.016]} rotation={[-2.641, 0.717, 2.797]} />
          <PerspectiveCamera name="2-camera" makeDefault={(scene1 == 'Volcap' ? true : false)} far={1000} near={0.1} fov={22.895} position={[15.73, 15.74, -24.96]} rotation={[-2.352, 0.712, 2.559]} />
          <PerspectiveCamera name="3-camera" makeDefault={(scene1 == 'VR' ? true : false)} far={1000} near={0.1} fov={22.895} position={[-14.686, 2.869, -14.625]} rotation={[-2.875, 1.337, 2.882]} />
          <PerspectiveCamera name="4-camera" makeDefault={(scene1 == 'Aria' ? true : false)} far={1000} near={0.1} fov={22.895} position={[-5.145, 10.943, -1.928]} rotation={[-2.678, 0.754, 2.812]} />
          <PerspectiveCamera name="5-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[28.38, 17.492, -1.582]} rotation={[-2.63, 0.762, 2.772]} />
          <spotLight name="spot-light4" intensity={0.637} angle={1.119} penumbra={0.15} decay={2} position={[-1.251, -0.932, -38.475]} rotation={[3.13, -0.111, 2.801]} scale={1.831}>
          ...
          <spotLight name="spot-light1" intensity={0.637} angle={0.588} penumbra={1} decay={2} position={[-30.401, 3.526, 17.719]} rotation={[-2.413, -0.571, -1.01]} scale={0.241}>
            <group position={[0, 0, -1]} />
          </spotLight>
          <spotLight name="area-light1" intensity={0.398} angle={1.223} penumbra={0.392} decay={2} color="#ffedca" position={[-12.195, 36.175, 2.646]} rotation={[-Math.PI / 2, 0, 0]} scale={3.635}>
            <group position={[0, 0, -1]} />
          </spotLight>
          <spotLight name="outside-light1" intensity={0.557} angle={1.122} penumbra={0.03} decay={2} color="#ffdc8d" position={[-82.688, 36.469, 2.646]} rotation={[-Math.PI / 2, -1.026, 0]} scale={3.635}>
            <group position={[0, 0, -1]} />
          </spotLight>
          <pointLight name="Point" intensity={0.239} decay={2} position={[-0.586, 8.197, 28.362]} rotation={[-Math.PI / 2, 0, 0]} />
          ...
          <group name="tv" position={[-38.031, 3.286, -12.896]} rotation={[-Math.PI / 2, 0, 0]}>
            <mesh name="Cube023_1" geometry={nodes.Cube023_1.geometry} material={materials.tv} />
            <mesh name="Cube023_2" geometry={nodes.Cube023_2.geometry} material={materials['tv-screen']} />
          </group>
...
useGLTF.preload('/gltf/lab-08-04-v1/lab-08-04.gltf')
