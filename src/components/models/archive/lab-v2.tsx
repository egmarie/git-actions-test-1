...
Command: npx gltfjsx@6.2.10 lab-07-26-v3.gltf 
*/

import { useRef, Suspense } from 'react'
import { useGLTF, PerspectiveCamera, useAnimations, OrbitControls } from '@react-three/drei'
import { extend, useThree } from '@react-three/fiber'
extend({ OrbitControls, useGLTF, PerspectiveCamera, useAnimations, useThree})
...
export default function Lab(props:any) {
  ...
  // const playVolCapGirl = (actions:any) => {
    actions['vol-cap-girl-animation']?.play()
  // }
  // const playLoomo = (actions:any) => {
  ...
  // }
  // const playVr = (actions:any) => {
    actions['VR-headset']?.play()
  // }
  // playLoomo(actions)
  // playAria(actions)
  // playVr(actions)
  // playVolCapGirl(actions)
  ...
  return (
    ...
    <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="animated-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[76.612, 48.828, -87.016]} rotation={[-2.641, 0.717, 2.797]} />
        ...
        <PerspectiveCamera name="1-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[76.612, 48.828, -87.016]} rotation={[-2.641, 0.717, 2.797]} />
        <PerspectiveCamera name="2-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[15.73, 15.74, -24.96]} rotation={[-2.352, 0.712, 2.559]} />
        <PerspectiveCamera name="3-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[-14.686, 2.869, -14.625]} rotation={[-2.875, 1.337, 2.882]} />
        <PerspectiveCamera name="4-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[-5.145, 10.943, -1.928]} rotation={[-2.678, 0.754, 2.812]} />
...
useGLTF.preload('/lab-07-26-v3.gltf')
