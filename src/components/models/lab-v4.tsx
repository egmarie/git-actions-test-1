...
Command: npx gltfjsx@6.2.10 lab-08-22.glb 
*/
...
export function Lab(props:any) {
  ...
  const { nodes, materials, animations, scene, cameras } = useGLTF('/gltf/lab-08-22.glb')
  ...
  return (
    ...
    <group ref={group} {...props} dispose={null} scale={(viewport.width < 12 ? (viewport.width / 27) : (viewport.width / 19))} rotation={[0.05, 179.9, 0]} object={scene} position={(viewport.width < 12 ? [-3, 0, -10] : [-6, -4, -17])} animations={animations} cameras={cameras}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="aria-camera" makeDefault={false} far={1000} near={0.1} fov={22.895} position={[21.317, 15.474, -8.783]} rotation={[-2.688, 0.579, 2.881]} />
